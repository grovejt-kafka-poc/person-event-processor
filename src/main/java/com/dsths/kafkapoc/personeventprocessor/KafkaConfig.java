...
public class KafkaConfig {
	...
	public Map<String, Object> consumerConfigs() {
		...
		props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.dsths.kafkatpoc.personservice.person");
	  ...
	  public ConsumerFactory<String, PersonEvent> consumerFactory() {
		    return new DefaultKafkaConsumerFactory<>(consumerConfigs(), new StringDeserializer(),
		            new JsonDeserializer<>(PersonEvent.class));
	  }

	  @Bean
	  public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, PersonEvent>> kafkaListenerContainerFactory() {
